...
parser.add_argument('--ckpt_ids', default=None, type=str, help='ckpt_ids list')
parser.add_argument('--dataset_tests', default=None, type=str, help='dataset_tests')
...
MLOps.log.add_test_results(
    ...
    args.dataset_tests,
    benchmark,
    name=f'test model on {args.dataset_tests}'
    )